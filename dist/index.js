...
var _this = this;
var GenerateFragments_1 = require("./GenerateFragments");
var command = {
    ...
    handler: function (context, argv) { return __awaiter(_this, void 0, void 0, function () {
        var generateFragments;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    generateFragments = new GenerateFragments_1.GenerateFragments(context, argv);
                    return [4 /*yield*/, generateFragments.handle()];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
